...
% the distance is N by N, the entry is 
% Dnm=  XAn^2+YAn^2 + XBm^2+YBm^2 - 2*XAnXBm- 2*YAnYBm
%    = (XAn-XBm)^2 + (YAn-YBm)^2
% n - row index, the index of the point in A
% m - colum index, the index of the point in B
